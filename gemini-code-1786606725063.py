...
def normalize_tags(raw_tags):
    ...
    # Словарные авто-замены известных опечаток
    corrections = {
        "antro": "anthro",
        "-antro": "-anthro"
    }
...
async def handle_wizard_callback(callback: CallbackQuery):
    ...
    if action.startswith("src_"):
        ...
        # Заменяем старый лейбл с таким же именем или сохраняем новый
...
async def handle_text_messages(message: Message):
    ...
    # Объявление всех глобальных переменных в самом начале
