    ...
    if media_group_id in pending_media_groups:
        ...
        if len(media_group) > 1:
            ...
            if has_caption:
                ...
                can_post_instantly = False  # Отключаем мгновенную публикацию – всегда очередь
    can_post_instantly = False  # Отключаем мгновенную публикацию – всегда идём через очередь
