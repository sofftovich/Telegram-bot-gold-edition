...
# Импорты для веб-сервера - обновлено для aiohttp 4.x
...
# =================================
# ВЕБ-СЕРВЕР НА AIOHTTP 4.x
# =================================

@web.middleware
async def logging_middleware(request, handler):
    """Middleware для логирования HTTP запросов - обновлено для aiohttp 4.x"""
...
def create_web_app():
    """Создаёт веб-приложение aiohttp 4.x с поддержкой CORS"""
    ...
    # Настройка CORS для aiohttp 4.x
