...
async def fetch_booru_posts(source, tags, limit=20):
    """Запрашивает посты через JSON API Rule34/Gelbooru с обходом авторизации"""
    posts = []
    
    # Исправлены заголовки бразуера для исключения ошибки 'Missing authentication'
    headers = {
...
def get_timezone_keyboard():
    buttons = [
        [
            InlineKeyboardButton(text="🇺АК Украина (Kyiv)", callback_data="tz:Europe/Kyiv"),
